...
export const translations = {
    ...
    home: {
      ...
      booking: {
        ...
        appointmentType: {
          ...
          description:
            "Choose whether you would like a checkup or a consultation.",
        ...
        doctor: {
          ...
          description:
            "Choose the doctor you would like to book your appointment with.",
        ...
        errors: {
          selectAppointmentType:
            "Please select Checkup or Consultation first.",
  ...
  ar: {
    header: {
      ...
      clinicAddress:
        "قنا - شارع جينودي - عمارة الدكاترة اعلى سان توماس للذهب",
    ...
    home: {
      hero: {
        ...
        desc:
          "استمتع برعاية أسنان متميزة مع فريقنا من المتخصصين ذوي الخبرة. نقدم علاجات مخصصة في بيئة عصرية ومريحة وهادئة، مصممة لراحة بالك.",
      ...
      services: {
        ...
        restorative: {
          ...
          desc:
            "زراعة أسنان وتيجان وجسور مصممة لاستعادة وظيفة وجمال أسنانك الطبيعي بشكل كامل.",
        },
      },
      ...
      cases: {
        ...
        error:
          "تعذر تحميل الحالات في الوقت الحالي.",
      ...
      footer: {
        ...
        copyright:
          "© 2026 عيادة الكمال لطب الأسنان. جميع الحقوق محفوظة.",
      },
      ...
      booking: {
        ...
        appointmentType: {
          ...
          description:
            "اختر نوع الموعد المناسب لك، سواء كشف أو استشارة.",
        ...
        doctor: {
          ...
          description:
            "اختر الطبيب الذي ترغب في حجز موعدك معه.",
        ...
        errors: {
          selectAppointmentType:
            "يرجى اختيار كشف أو استشارة أولًا.",

          selectDoctor:
            "يرجى اختيار طبيب أولًا.",
        ...
        buttons: {
          continueToDoctor:
            "المتابعة لاختيار الطبيب",

          continueToDateTime:
            "المتابعة لاختيار التاريخ والوقت",

          continueToPatient:
            "المتابعة لإدخال بيانات المريض",
    ...
    gallery: {
      ...
      noCases:
        "لا توجد حالات تطابق الفلاتر المحددة.",

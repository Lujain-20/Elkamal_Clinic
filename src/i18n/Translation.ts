...
export const translations = {
  en: {
    ...
    home: {
      ...
      footer: {
        brandDesc:
          "Providing premium, personalized dental care in a modern and tranquil environment.",
        ...
        copyright: "© 2024 ELKAMAL Dental Clinic. All Rights Reserved.",
      },
...
gallery: {
  ...
  ar: {
    header: {
      ...
      logoText: "الكمال لطب الاسنان بقنا ",   
    ...
    home: {
      ...
      footer: {
        ...
        copyright: "© 2024 عيادة الكمال لطب الأسنان. جميع الحقوق محفوظة.",
      },
